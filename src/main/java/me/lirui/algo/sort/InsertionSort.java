 ...
 *
 * <p>Complexity Analysis: Time Complexity: O(N^2) Space Complexity: No auxiliary space.
 *
 * <p>pseudo code:
 *
 * <p>for j = 2 to A.length key = A[j] // insert A[j] into the sorted array A[1...j - 1] i = j - 1
 * while i > 0 and A[i] > key A[i + 1] = A[i] A[i] = key i = i - 1
 *
